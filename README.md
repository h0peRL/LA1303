...
| 5          | 3.2.2023  | VSCode geöffnet<br />API gestartet und Live Server gestartet  | 1. Login Page offenhaben und nach unten Scrollen                                                                                                       | 2.<br /> Daten werden agezeigt                                                                                  |
...
| 9          | 3.2.2023  | VSCode geöffnet, HTML seite geöffnet                          | HTML inspizieren                                                                                                                                       | HTML sollte footer und header beeinhalten.                                                                      |
